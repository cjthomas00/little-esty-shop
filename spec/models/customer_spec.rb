...
RSpec.describe Customer, type: :model do
  ...
  before :each do
    ...
    it '::top_five_customer' do
      expect(Customer.top_five_customer).to eq([@customer2, @customer3, @customer5, @customer1, @customer6])
    end

    it "it tells the top_successful_transactions" do
      expect(@customer1.top_successful_transactions).to eq(20)
      expect(@customer1.top_successful_transactions).to_not eq(10)
    end
